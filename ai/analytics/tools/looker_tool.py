...
def get_looker_devops_url() -> dict:
    """
    Return the analytics dashboard URL for the DevOps/infrastructure audience.
...
def get_looker_tech_url() -> dict:
    """
    Return the analytics dashboard URL for the Technical/ML audience.
...
def get_looker_business_url() -> dict:
    """
    Return the analytics dashboard URL for the Business/executive audience.
...
def get_all_looker_urls() -> dict:
    """Return all three dashboard section URLs in a single call."""
    return {
